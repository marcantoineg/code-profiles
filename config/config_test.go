...
`
	...
	sharedTestRuns = []struct {
	...
	}{
		{
			...
			&Profile{Name: "base", ExtsInstallPath: "./base", Extensions: []string{"some.very.real.ext.id"}},
			false,
			false,
		},
		{
			...
			&Profile{Name: "base2", ExtsInstallPath: "./base2", Extensions: []string{"some.very.real.ext.id"}},
			false,
			false,
		},
		{
